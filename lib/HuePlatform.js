...
module.exports = class HuePlatform extends LibPlatform {
  ...
  httpGet(url, ipv6 = false) {
    ...
    let requestMsg;
    requestMsg = util.format('%s %s', requestObj.method, requestObj.url);
