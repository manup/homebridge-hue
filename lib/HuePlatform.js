...
function setHomebridge(homebridge) {
  ...
  LibPlatform.createCharacteristic(
    'Last Updated', '00000023-0000-1000-8000-656261617577', {
      format: Characteristic.Formats.STRING,
      perms: [Characteristic.Perms.READ, Characteristic.Perms.NOTIFY]
    }
  );
  ...
  LibPlatform.createCharacteristic(
    'Any On', '00000028-0000-1000-8000-656261617577', {
      format: Characteristic.Formats.BOOL,
      perms: [Characteristic.Perms.READ, Characteristic.Perms.NOTIFY,
              Characteristic.Perms.WRITE]
    }
  ...
  LibPlatform.createCharacteristic(
    'Last Triggered', '00000029-0000-1000-8000-656261617577', {
      format: Characteristic.Formats.STRING,
      perms: [Characteristic.Perms.READ, Characteristic.Perms.NOTIFY]
    }
  );
  ...
  LibPlatform.createCharacteristic(
    'Times Triggered', '0000002A-0000-1000-8000-656261617577', {
      format: Characteristic.Formats.INT,
      perms: [Characteristic.Perms.READ, Characteristic.Perms.NOTIFY]
    }
  );
  ...
  LibPlatform.createCharacteristic(
    'Color Temperature', 'A18E5901-CFA1-4D37-A10F-0071CEEEEEBD', {
      format: Characteristic.Formats.INT,
      unit: 'K',
      minValue: 2000,
      maxValue: 6536,
  ...
  LibPlatform.createCharacteristic(
    'Unique ID', 'D8B76298-42E7-5FFD-B1D6-1782D9A1F936', {
      format: Characteristic.Formats.STRING,
      perms: [Characteristic.Perms.READ]
    }
  );
  ...
  foundBridge(bridge) {
    ...
    .then(function (bridge) {
      if (this.foundBridges[bridge.id]) {
        ...
        this.hueBridges[bridge.id] = new HueBridgeAccessory(this, bridge);
      }
