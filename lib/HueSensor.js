  ...
  switch (this.obj.type) {
    ...
    case 'ZHASwitch':
      if (
        ...
        // Busch-Jaeger Light Link control element (mains-powered: 1gang, 2gang, 4gang)
        // Busch-Jaeger Light Link wall-mounted transmitter (battery: 1-channel, 2-channel, 4-channel)
        this.createLabel(Characteristic.ServiceLabelNamespace.ARABIC_NUMERALS)
        if (this.endpoint === '0a') {
